...
import { Button, Divider, TextField, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from '@material-ui/core';
...
const EditAddRow = (props) => {
    const {isEdit, error,onEditCategory, onAddCategory, message,closeDialog,id, title, name} = props
    ...
    return (
        <div>
          ...
          <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title" fullWidth >
                <form>
                    <DialogTitle className={classes.title} >{isEdit ? "Edit Category" : "Add Catedory"}</DialogTitle>
                    ...
                    <DialogActions>
                        ...
                        <Button color="primary" variant="contained" type="submit" onClick={(e) => {
                                e.preventDefault();
                                isEdit ? onEditCategory(id, categoryName): onAddCategory(categoryName);
                                setCategoryName('');
                            }
                        } >
                           { isEdit ?  "Save": "Add" }
...
const mapDispatchToProps = (dispatch) => {
    return {
      onEditCategory:(id,categoryName)=> dispatch(categoriesActions.editCategoryById(id,categoryName)),
      onAddCategory: (category) => dispatch(categoriesActions.addCategory(category)),
